...
def make_compression_relational(base_folder, f2, f1, num_steps):
    ...
    for f in f2:
        try:
            ...
            pass
        os.mkdir(f)
    x, y = compression_convert(f1, f2, num_steps, dfile = '.npy', input2 = [5])
    with open(os.path.join(base_folder, 'x.pickle'), 'wb') as f:
        pickle.dump(x, f)
    with open(os.path.join(base_folder, 'y.pickle'), 'wb') as f:
        pickle.dump(y, f)
...
if __name__ == '__main__':
    ...
    folder2 = ['./storage_pipeline/storage_relational_compression/relational_arr']
    ...
    make_compression_relational(base_folder, folder2, 'compression_tests_3/relational_pipeline', num_steps = 5)
