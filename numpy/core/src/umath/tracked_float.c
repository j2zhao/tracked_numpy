...
//SIGNATURE SUPPORTED ONLY FOR TESTING
TFLOAT_UNARY_UFUNC(sin, a)
TFLOAT_UNARY_UFUNC(cos, a)
TFLOAT_UNARY_UFUNC(tan, a)
TFLOAT_UNARY_UFUNC(arcsin, a)
TFLOAT_UNARY_UFUNC(arccos, a)
TFLOAT_UNARY_UFUNC(arctan, a)
TFLOAT_BINARY_UFUNC(hypot, a + b)
TFLOAT_BINARY_UFUNC(arctan2, a + b)
TFLOAT_UNARY_UFUNC(radians, a)
TFLOAT_UNARY_UFUNC(degrees, a)
TFLOAT_UNARY_UFUNC(deg2rad, a)
TFLOAT_UNARY_UFUNC(rad2deg, a)
TFLOAT_UNARY_UFUNC(sinh, a)
TFLOAT_UNARY_UFUNC(cosh, a)
TFLOAT_UNARY_UFUNC(tanh, a)
TFLOAT_UNARY_UFUNC(arcsinh, a)
TFLOAT_UNARY_UFUNC(arccosh, a)
TFLOAT_UNARY_UFUNC(arctanh, a)
TFLOAT_UNARY_UFUNC(exp, a)
TFLOAT_UNARY_UFUNC(expm1, a)
TFLOAT_UNARY_UFUNC(exp2, a)
TFLOAT_UNARY_UFUNC(log, a)
TFLOAT_UNARY_UFUNC(log10, a)
TFLOAT_UNARY_UFUNC(log2, a)
TFLOAT_UNARY_UFUNC(log1p, a)
TFLOAT_BINARY_UFUNC(logaddexp, a + b)
TFLOAT_BINARY_UFUNC(logaddexp2, a + b)
TFLOAT_BINARY_UFUNC(copysign, a + b)
TFLOAT_BINARY_UFUNC(ldexp, a + b)
TFLOAT_BINARY_UFUNC(nextafter, a + b)
TFLOAT_UNARY_UFUNC(spacing, a)
TFLOAT_UNARY_UFUNC(reciprocal, a)
TFLOAT_UNARY_UFUNC(positive, a)
TFLOAT_BINARY_UFUNC(power, a + b)
TFLOAT_BINARY_UFUNC(float_power, a + b)
TFLOAT_BINARY_UFUNC(fmod, a + b)
TFLOAT_BINARY_UFUNC(mod, a + b)
TFLOAT_BINARY_UFUNC(remainder, a + b)
TFLOAT_UNARY_UFUNC(conj, a)
TFLOAT_BINARY_UFUNC(fmax, a + b)
TFLOAT_BINARY_UFUNC(fmin, a + b)
TFLOAT_UNARY_UFUNC(sqrt, a)
TFLOAT_UNARY_UFUNC(cbrt, a)
TFLOAT_UNARY_UFUNC(fabs, a)
TFLOAT_BINARY_UFUNC(heaviside, a + b)
...
#define REGISTER_UFUNC(name,...) { \
    ...
    /*TEST FUNCTIONS*/
    REGISTER_UFUNC_UNARY(sin)
    REGISTER_UFUNC_UNARY(cos)
    REGISTER_UFUNC_UNARY(tan)
    REGISTER_UFUNC_UNARY(arcsin)
    REGISTER_UFUNC_UNARY(arccos)
    REGISTER_UFUNC_UNARY(arctan)
    REGISTER_UFUNC_UNARY(radians)
    REGISTER_UFUNC_UNARY(degrees)
    REGISTER_UFUNC_UNARY(deg2rad)
    REGISTER_UFUNC_UNARY(rad2deg)
    REGISTER_UFUNC_UNARY(sinh)
    REGISTER_UFUNC_UNARY(cosh)
    REGISTER_UFUNC_UNARY(tanh)

    REGISTER_UFUNC_UNARY(arcsinh)
    REGISTER_UFUNC_UNARY(arccosh)
    REGISTER_UFUNC_UNARY(arctanh)
    REGISTER_UFUNC_UNARY(exp)
    REGISTER_UFUNC_UNARY(expm1)
    REGISTER_UFUNC_UNARY(exp2)
    REGISTER_UFUNC_UNARY(log)
    REGISTER_UFUNC_UNARY(log10)
    REGISTER_UFUNC_UNARY(log2)
    REGISTER_UFUNC_UNARY(log1p)
    REGISTER_UFUNC_UNARY(spacing)
    REGISTER_UFUNC_UNARY(reciprocal)

    REGISTER_UFUNC_UNARY(positive)
    REGISTER_UFUNC_UNARY(conj)
    REGISTER_UFUNC_UNARY(sqrt)
    REGISTER_UFUNC_UNARY(cbrt)
    REGISTER_UFUNC_UNARY(fabs)

    REGISTER_UFUNC_BINARY_TFLOAT(hypot)
    REGISTER_UFUNC_BINARY_TFLOAT(arctan2)
    REGISTER_UFUNC_BINARY_TFLOAT(logaddexp)
    REGISTER_UFUNC_BINARY_TFLOAT(logaddexp2)
    REGISTER_UFUNC_BINARY_TFLOAT(copysign)
    REGISTER_UFUNC_BINARY_TFLOAT(ldexp)
    REGISTER_UFUNC_BINARY_TFLOAT(nextafter)
    REGISTER_UFUNC_BINARY_TFLOAT(power)
    REGISTER_UFUNC_BINARY_TFLOAT(float_power)
    REGISTER_UFUNC_BINARY_TFLOAT(fmod)
    REGISTER_UFUNC_BINARY_TFLOAT(mod)
    REGISTER_UFUNC_BINARY_TFLOAT(remainder)
    REGISTER_UFUNC_BINARY_TFLOAT(fmax)
    REGISTER_UFUNC_BINARY_TFLOAT(fmin)
    REGISTER_UFUNC_BINARY_TFLOAT(heaviside)
