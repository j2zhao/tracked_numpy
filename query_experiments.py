...
if __name__ == '__main__':
    ...
    #     experiments = [1, 10, 100, 1000, 10000, 100000], num_steps = 10, num_exp = 20, save_name = 'query_results_10/numpy_pq_results', folder_name = 'storage_10/numpy_raw', forward = False)
